                ...
                <form id="cart" method="POST">
                  ...
                  <table name="cart table  responsive text-center">
                    <div class="row text-center mx-auto">
                      ...
                      <div class="col-xl-5 mt-2">
                        <div class="form-group mx-2">
                          <select class="form-control supname" name="supname" id="name_suppler" required="" value="">
                            <option disabled>Supplier Name</option>
                            <?php
                            $sqls = $connection->query("SELECT * FROM `supplier`");
                    ...
                    <tr class="line_items text-center " style="margin-top:5px;">
                      ...
                      <td> <select class="form-control product_name" style="margin-top: 11px;" required="" name="product" >
                          <option disabled>Select Product_Name</option>
                          <?php
                          $sql = mysqli_query($connection, "select * from products where status = 'Active'");
...
<div class="container-fluid pt-4 px-4">
          ...
          <i class="fas fa-plus"></i> Add Purchase
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                    <?php
          $squery = "select * from purchase_detail ORDER BY bill_id DESC";
          ...
          ?>
            ...
            <tr>
              ...
              <td>
                <?php
                $query = mysqli_query($connection, "select * from items where bill_id='$bill'");
